...
# 自定义排序（保持原有序号）
sorted_files=("ttf解包ttx" "ttx打包ttf" "分解ttc" "可变字体母版重量_查看+修改" "提取VF字体指定字重"  "修改字体版本信息" "查看字体upm值" "修改字体upm为1000+手动选择改度_量" "字体字符合并" "字体百分比缩放" "修改英文标点间距" "修改ttf信息" "生成mtz" "update_code")
